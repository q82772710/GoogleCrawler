...
def main():
    ...
    pare = "C:\\Users\\Administrator\\Desktop\\"

    ifname = pare + "fire2016-microblog-track-tweetids.txt"
    ofname = pare + "fire2016-microblog-track-tweetids.jsonl"

    # ifname = pare + "NepalQuake-code-mixed-training-tweetids.txt"
    # ofname = pare + "NepalQuake-code-mixed-training-tweets-2.jsonl"
